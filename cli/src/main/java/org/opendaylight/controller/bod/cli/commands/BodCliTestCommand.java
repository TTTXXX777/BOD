 ...
 */
package org.opendaylight.controller.bod.cli.commands;
...
public class BodCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(BodCliTestCommand.class);
    protected final BodCliCommands service;

    public BodCliTestCommand(final BodCliCommands service) {
